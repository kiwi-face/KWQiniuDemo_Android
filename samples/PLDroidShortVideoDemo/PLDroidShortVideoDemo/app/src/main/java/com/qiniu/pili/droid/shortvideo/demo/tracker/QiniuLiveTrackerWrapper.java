...
/**
 * TODO:请关掉七牛直播自带美颜，接口类,所有对kiwi face sdk的调用都封装在这个类里面
            ...
            public void onAdjustFaceBeauty(int type, float param) {
                switch (type) {
                    case BEAUTY_BIG_EYE_TYPE:
                        getKwTrackerManager().setEyeMagnifying(param);
                        break;
                    case BEAUTY_THIN_FACE_TYPE:
                        getKwTrackerManager().setChinSliming(param);
                        break;
                    case SKIN_SHINNING_TENDERNESS:
                        getKwTrackerManager().setSkinTenderness(param);
                        break;
                    case SKIN_TONE_SATURATION:
                        getKwTrackerManager().setSkinSaturation(param);
                        break;
                    case REMOVE_BLEMISHES:
                        getKwTrackerManager().setSkinBlemishRemoval(param);
                        break;
                    case SKIN_TONE_PERFECTION:
                        getKwTrackerManager().setSkinWhitening(param);
                        break;
                }
