...
import com.kiwi.track.QiniuLiveTrackerWrapper;
...
//            Toast.makeText(this, "Invalid Publish Url", Toast.LENGTH_LONG).show();
        ...
        mProfile.setVideoQuality(StreamingProfile.VIDEO_QUALITY_HIGH1)
                .setAudioQuality(StreamingProfile.VIDEO_QUALITY_MEDIUM1)
...
//                .setEncodingOrientation(StreamingProfile.ENCODING_ORIENTATION.PORT)
        ...
        mCameraStreamingSetting.setCameraId(Camera.CameraInfo.CAMERA_FACING_BACK)
                ...
                .setCameraSourceImproved(true)//TODO:实现在onDrawFrame一个地方渲染，屏幕推流都有显示效果
                .setPreviewSizeOptimize(true)
...
//                .setFocusMode(CameraStreamingSetting.FOCUS_MODE_CONTINUOUS_PICTURE)
        ...
        qiniuLiveTrackerWrapper = new QiniuLiveTrackerWrapper(this, mCameraStreamingSetting.getCameraFacingId().ordinal());
...
//        if(isDebug) Log.d(TAG,"onPreviewFrame,bytes size:"+bytes.length+",w:"+width+",h:"+height+",rotation:"+rotation+",fmt:"+fmt+",tsInNanoTime:"+tsInNanoTime);
    ...
    public int onDrawFrame(int texId, int texWidth, int texHeight, float[] transformMatrix) {
        return qiniuLiveTrackerWrapper.onDrawFrame(texId, texWidth, texHeight);
    }
...
//        }
    ...
    private StreamingState mCurrentStreamState = PREPARING;

    @Override
    public void onStateChanged(StreamingState streamingState, Object extra) {
        Log.i(TAG, "StreamingState streamingState:" + streamingState + ",extra:" + extra);

        this.mCurrentStreamState = streamingState;
...
//                mShutterButtonPressed = false;
    ...
    private class Switcher implements Runnable {
        ...
        public void run() {
            ...
            Log.i(TAG, "onSwitchCamera:" + facingId);
    ...
    private void setHtmlText(TextView tx, String mainText, String subText) {
        String html = "<font size=\"2\">%s</font><br/>" +
                "<font size=\"1\" color=\"#00bbaa\">%s</font>";
        tx.setText(Html.fromHtml(String.format(html, mainText, subText)));
    }
}
